...
<tr><td>Email:<td><input type="email" class="form-control" name="txtid" placeholder="Enater User Email Id"required></tr><br>
...
<tr><td>Password:<td><input type="password" class="form-control" name="txtpass" pattern=".{6,12}" title="6 to 12 chracters" placeholder="Enater Password" required></tr><br>
