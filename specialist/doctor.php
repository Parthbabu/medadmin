                      ...
                      <!--  <li>
                        ...
                        <!--</li>--><li>
                            <a href="#"><i class="fa fa-table nav_icon"></i>Tables</span></a><br>
									...
									<a href="specialist_tbl.php"><i class="fa fa-table nav_icon"></i>Specialist</a><br>
...
$sql="select s.*,d.* from doctor_mst d,doc_specialist s where s.pk_spec_id=d.fk_spec_id AND s.pk_spec_id='".$_id."'";
