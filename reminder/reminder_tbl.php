                      ...
                      <!--  <li>
                        ...
                        <li>
                                <a href="#"><i class="fa fa-table nav_icon"></i>Tables</span></a><br>
									...
									<a href="reminder_tbl.php"><i class="fa fa-table nav_icon"></i>Reminder</a><br>
    ...
    <table class="table" id="dataTables">
      <thead>
        <tr>
          ...
          <th>Title<span class="glyphicon glyphicon-sort"></th>
          <th>Description<span class="glyphicon glyphicon-sort"></th>
          <th>StartDate<span class="glyphicon glyphicon-sort"></th>
          <th>EndDate<span class="glyphicon glyphicon-sort"></th>
          <th>Action</th>
        </tr>
      </thead>
      <tbody>
      ...
      while($row=$res->fetch_assoc())
{
       ...
       echo '<tr class="success">';
           ...
           echo '<td>'. $row["rem_title"] .'</td>';
           echo '<td>'. $row["rem_desc"] .'</td>';
...
<div class="copy_layout">
      <p>Copyright &copy; 2018 MedSky. All Rights Reserved | Design by Parth Shah </p>
  </div>
   </div>
      </div>
      <!-- /#page-wrapper -->
