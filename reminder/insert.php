...
<tr><td>StartDate:<td><input type="datetime-local" id="date"  value="05-06-2018" class="form-control" name="txtsdate" placeholder="Enter Start Date" ></tr><br>
<tr><td>EndDate:<td><input type="datetime-local" id="date"  value="05-06-2018" class="form-control" name="txtedate" placeholder="Enter End Date" ></tr><br>
