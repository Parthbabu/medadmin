                      ...
                      <!--  <li>
                        ...
                        <!--</li>--><li>
                            <a href="#"><i class="fa fa-table nav_icon"></i>Tables</span></a><br>
									...
									<a href="degree_tbl.php"><i class="fa fa-table nav_icon"></i>Degree</a><br>
...
$sql="select de.*,d.* from doctor_mst d,doc_degree de where de.pk_deg_id=d.fk_deg_id AND de.pk_deg_id='".$_id."'";
