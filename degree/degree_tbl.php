      ...
      while($row=$res->fetch_assoc())
{
       ...
       echo '<tr class="success">';
           ...
           echo '<td>'. $row["pk_deg_id"] .'</td>';
        //   echo '<td>'. $row["deg_name"] .'</td>';
           echo '<td><a href="doctor.php?id='.$row["pk_deg_id"].'">'. $row["deg_name"] .'</a></td>';
           echo '<td> <a href="delete.php?id='.$row["pk_deg_id"].'"><span class="glyphicon glyphicon-trash"></span></a>
             <a href="update.php?id='.$row["pk_deg_id"].'"> | <span class="glyphicon glyphicon-pencil"></span></a></td>';
