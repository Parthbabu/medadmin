...
<div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="../shared/doctor/doctor_tbl.php">Doctor</a>
                                    <a href="../shared/user/user_tbl.php">User</a>
                                    <a href="../shared/medicine/medicine_tbl.php">Medicne</a>
                                    <a href="../shared/prescription/prescription_tbl.php">Prescription</a>
    ...
    <div class="copy_layout">
         <p>Copyright &copy; 2018 MedSky. All Rights Reserved | Design by <a href="http://w3layouts.com/" target="_blank">Parth Shah</a> </p>
       </div>
   </div>
      </div>
      <!-- /#page-wrapper -->
