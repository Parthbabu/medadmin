...
<a href="#"><i class="fa fa-table nav_icon"></i>Tables</span></a><br>
									...
									<a href="like_tbl.php"><i class="fa fa-table nav_icon"></i>Like</a>
    ...
    <table class="table" id="dataTables">
      <thead>
        <tr>
          ...
          <th>Blog Description<span class="glyphicon glyphicon-sort"></span></th>
...
//$res=specialist::select_all1($id);
$_id=$_GET["id"];
$conn=new mysqli("localhost","root","","medsky");
$sql="select l.*,b.* from likes_tbl l,blog_tbl b where l.fk_blog_id=b.blog_id AND l.like_id='".$_id."'";
      ...
      while($row=$result->fetch_assoc())
{
       ...
       echo '<tr class="success">';
         ...
         //  echo '<td>'. $row["pk_spec_id"] .'</td>';
           echo '<td>'. $row["blog_desc"] .'</td>';
           //echo '<td> <a href="delete.php?id='.$row["pk_spec_id"].'"><span class="glyphicon glyphicon-trash"></span></a>
             //<a href="update.php?id='.$row["pk_spec_id"].'"> | <span class="glyphicon glyphicon-pencil"></span></a></td>';
