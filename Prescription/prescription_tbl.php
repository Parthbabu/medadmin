                      ...
                      <!--  <li>
                        ...
                        <!--</li>-->                       <li>
                                <a href="#"><i class="fa fa-table nav_icon"></i>Tables</span></a><br>
								    ...
								    <a href="prescription_tbl.php"><i class="fa fa-table nav_icon"></i>Prescription</a><br>
    ...
    <table class="table" id="dataTables">
      <thead>
        <tr>
          ...
          <th>ID<span class="glyphicon glyphicon-sort"></th>
          <th>User<span class="glyphicon glyphicon-sort"></th>
          <th>Doctor<span class="glyphicon glyphicon-sort"></th>
          <th>MId<span class="glyphicon glyphicon-sort"></th>
          <th>Morning<span class="glyphicon glyphicon-sort"></th>
          <th>Noon<span class="glyphicon glyphicon-sort"></th>
          <th>night<span class="glyphicon glyphicon-sort"></th>
          <th>Ins<span class="glyphicon glyphicon-sort"></th>
          <th>Day<span class="glyphicon glyphicon-sort"></th>
          <th>Date<span class="glyphicon glyphicon-sort"></th>
          <th>Action</th>
        </tr>
      </thead>
      <tbody>
...
$res=prescription_all::select_all1();
      ...
      while($row=$res->fetch_assoc())
{
       ...
       echo '<tr class="success">';
           ...
           echo '<td>'. $row["pk_pres_id"] .'</td>';
           echo '<td>'. $row["usr_name"] .'</td>';
           echo '<td>'. $row["doc_name"] .'</td>';
           echo '<td>'. $row["col_medids"] .'</td>';
           echo '<td>'. $row["pres_morning"] .'</td>';
           echo '<td>'. $row["pres_noon"] .'</td>';
           echo '<td>'. $row["pres_night"] .'</td>';
           echo '<td>'. $row["pres_instr"] .'</td>';
           echo '<td>'. $row["pres_day"] .'</td>';
           echo '<td>'. $row["pres_date"] .'</td>';
           echo '<td> <a href="delete.php?id='.$row["pk_pres_id"].'"><span class="glyphicon glyphicon-trash"></span></a>
             <a href="update.php?id='.$row["pk_pres_id"].'"> | <span class="glyphicon glyphicon-pencil"></span></a></td>';
